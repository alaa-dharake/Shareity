...
<form class="register-form" action="/create-user" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-item">
        ...
        <input type="facebook_link" name="facebook_link" id="facebook_link" placeholder="paste link here" required>
    </div>
    <div class="form-item">
        <label for="twitter_link">Twitter link</label>
        <input type="twitter_link" name="twitter_link" id="twitter_link" placeholder="paste link here" required>
    </div>
    <div class="form-item">
        <label for="instagram_link">Instagram link</label>
        <input type="instagram_link" name="instagram_link" id="instagram_link" placeholder="paste link here" required>
    </div>
