...
<body>
    ...
    <div id="wrapper">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item">
                        <a href="Security.html" class="menu-link">
                            ...
                            <span class="menu-text"> Donation History</span>
                        </a>
                    </li>
        ...
        <div class="content-page">
            ...
            <div class="content" style="background-image: url({{asset('assets/images/Untitled\ design\ \(54\).jpg)')}}">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="container">
                                                ...
                                                <div class="avatar-upload">
                                                    ...
                                                    <div>
                                                        <div id="imagePreview">
                                                            <img id="uploadedImage" src="{{asset('/CSC499/assets/images/homepage/chef-one.jpg')}}" class="me-2 rounded-circle" height="200" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
