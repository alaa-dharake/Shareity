                            ...
                            <div class="card-body py-2 px-3 border-bottom border-light">
                                <div class="row justify-content-between py-1">
                                    <div class="col-sm-7">
                                        ...
                                        <div class="container">
                                            <form action="{{ route('chef.meals')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="input-data">
                                                        ...
                                                        {{-- <input type="time" required id="startTimeInput" style="display:none;" name="start_time">  --}}
                                                    </div>                                               
                                                </div>
                                                <div class="form-row">
                                                    <div class="input-data">
                                                    ...
                                                    <div class="input-data">
                                                        ...
                                                        {{-- <input type="date" required id="startDateInput" style="display:none;" name="start_date"> --}}
                                                    </div>
                                                </div>
