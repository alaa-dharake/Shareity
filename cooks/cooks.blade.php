<div id="login-container">
    <a href="Cooks-details.html">
      <img class="profile-img" src="{{asset("assets/images/homepage/png-clipart-creative-chef-cartoon-character-s-chef-cartoon-characters.png")}}">
  </a>
  <h1>Cook 01</h1>
      <div>
      <div class="contents">
    ...
    <div class="container">
        <div class="screen-togo">
            <ul class="menu-items">
                <!--    Menu Item 1    -->
                <li class="menu-item">
                    <img src="{{asset("assets/images/meals/plate__french-fries.webp")}}" alt="French Fries with Ketchup"
                        class="menu-image">
                ...
                <!--    Menu Item 2    -->
                <li class="menu-item">
                    <img src="{{asset("assets/images/meals/plate__salmon-vegetables.webp")}}" alt="Salmon and Vegetables"
                        class="menu-image">
                    <div class="menu-item-dets">
                ...
                <!--    Menu Item 3    -->
                <li class="menu-item">
                    <img src="{{asset("assets/images/meals/plate__spaghetti-meat-sauce.webp")}}" alt="Spaghetti with Sauce"
                        class="menu-image">
                    <div class="menu-item-dets">
