                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form method="POST" action="{{ route('meals.update', $dish->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-section">
                                        ...
                                        <input id="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity"
                                            value="{{ old('quantity', $dish->quantity) }}" required autocomplete="quantity">
                                        @error('quantity')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <input id="startTime" type="time" class="form-control @error('startTime') is-invalid @enderror" name="startTime"
                                            value="{{ old('startTime', $dish->startTime) }}" required autocomplete="startTime">
                                        @error('startTime')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <input id="endTime" type="time" class="form-control @error('endTime') is-invalid @enderror" name="endTime"
                                            value="{{ old('endTime', $dish->endTime) }}" required autocomplete="endTime">
                                        @error('endTime')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <input id="day" type="date" class="form-control @error('day') is-invalid @enderror" name="day"
                                            value="{{ old('day', $dish->day) }}" required autocomplete="day">
                                        @error('day')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-section">
                                        ...
                                        @if ($dish->image)
                                            <div>
                                                <img src="{{ asset('storage/' . $dish->image) }}" alt="Meal Image" style="max-width: 200px; margin-top: 10px;">
                                            </div>
                                        @endif
                                    </div>
